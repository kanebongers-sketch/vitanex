          ...
          >
            ...
            <div className={`flex flex-col gap-0.5 max-w-[70%] ${isIk ? 'items-end' : 'items-start'}`}>
              ...
              <div
                ...
                style={{
                  background: isIk ? 'var(--vitanex-primary)' : 'white',
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <button
              ...
              style={{ background: actieveChat === 'team' ? 'var(--vitanex-primary-light)' : 'transparent' }}
              onMouseEnter={e => { if (actieveChat !== 'team') (e.currentTarget as HTMLElement).style.background = '#f9fafb' }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = actieveChat === 'team' ? 'var(--vitanex-primary-light)' : 'transparent' }}
            >
              <div
            ...
            {laden ? (
              <div className="flex justify-center py-6">
                <div className="w-5 h-5 rounded-full border-2 border-gray-200 animate-spin" style={{ borderTopColor: 'var(--vitanex-primary)' }} />
              </div>
            ) : teamleden.map(lid => (
              <button
                key={lid.id}
                ...
                className="w-full flex items-center gap-3 px-4 py-3 transition text-left"
                style={{ background: actieveChat === lid.id ? 'var(--vitanex-primary-light)' : 'transparent' }}
                onMouseEnter={e => { if (actieveChat !== lid.id) (e.currentTarget as HTMLElement).style.background = '#f9fafb' }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = actieveChat === lid.id ? 'var(--vitanex-primary-light)' : 'transparent' }}
              >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-0.5">
            {laden || (!isTeam && dmLaden) ? (
              <div className="flex justify-center items-center h-full">
                <div className="w-8 h-8 rounded-full border-2 border-gray-300 animate-spin" style={{ borderTopColor: 'var(--vitanex-primary)' }} />
              </div>
            ) : isTeam && teamBerichten.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center gap-3">
                <div className="w-16 h-16 rounded-full flex items-center justify-center text-3xl" style={{ background: 'var(--vitanex-primary-light)' }}>💬</div>
              ...
              <div className="flex flex-col items-center justify-center h-full text-center gap-3">
                <div className="w-16 h-16 rounded-full flex items-center justify-center text-3xl" style={{ background: 'var(--vitanex-primary-light)' }}>✉️</div>
            ...
            <div className="flex items-end gap-2">
              ...
              <div className="flex-1 flex items-end gap-2 rounded-2xl border border-gray-200 px-3 py-2" style={{ background: '#F0F2F5' }}>
                ...
                <button
                  ...
                  style={{ background: (isTeam ? teamInput.trim() : dmInput.trim()) ? 'var(--vitanex-primary)' : '#e5e7eb' }}
                >
