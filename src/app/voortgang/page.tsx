          ...
          <>
            ...
            {streak && (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 20 }}>
                {[
                  { label: 'Huidige streak', waarde: streak.huidige_streak, suffix: 'dagen', kleur: '#1D9E75', icon: '🔥' },
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 }}>
              {[
                ...
                { href: '/groeiplan', label: 'Groeiplan', tekst: 'AI-gegenereerd persoonlijk groeiplan', kleur: '#1D9E75', icon: '🌱' },
