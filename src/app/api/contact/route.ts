...
/** Valideert de payload handmatig; retourneert een NL-foutmelding of de schone data. */
function valideerPayload(body: unknown): { fout: string } | { data: ContactPayload } {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resultaat = valideerPayload(body)
