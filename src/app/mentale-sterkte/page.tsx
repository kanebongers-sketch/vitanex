        ...
        {!resultaat ? (
          ...
          <>
            <header style={{ marginBottom: 24, textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 14, color: '#9CA3AF' }}>Score: {resultaat.score}/100</p>
            ...
            <div style={{ background: 'white', borderRadius: 20, padding: '20px', border: '1px solid #E5E7EB', marginBottom: 20 }}>
              ...
              <p style={{ fontSize: 13, color: '#374151', lineHeight: 1.65 }}>{resultaat.analyse}</p>
            </div>

            <div style={{ background: 'white', borderRadius: 16, padding: '16px', border: '1px solid #E5E7EB', marginBottom: 20 }}>
              <p style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#9CA3AF', marginBottom: 12 }}>
              ...
              {resultaat.per_vraag.map((pv, i) => (
                <div key={i} style={{ marginBottom: 10 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
                    <p style={{ fontSize: 11, color: '#374151', flex: 1, marginRight: 8 }}>{pv.vraag}</p>
                    <span style={{ fontSize: 11, fontWeight: 700, color: pv.score >= 4 ? '#1D9E75' : pv.score >= 3 ? '#F59E0B' : '#EF4444', flexShrink: 0 }}>
                      {pv.score}/5
                    </span>
                  </div>
                  <div style={{ height: 3, borderRadius: 9999, background: '#F3F4F6', overflow: 'hidden' }}>
