...
export const METRICS: Record<MetricKey, MetricConfig> = {
  stappen: {
    ...
    kleur: 'var(--mf-green)', kleurLicht: 'var(--mf-green-light)',
  ...
  slaap: {
    ...
    kleur: 'var(--mf-purple)', kleurLicht: 'var(--mf-purple-light)',
  ...
  hartslag: {
    ...
    kleur: 'var(--mf-red)', kleurLicht: 'var(--mf-red-light)',
  ...
  welzijn: {
    ...
    kleur: 'var(--mentaforce-primary)', kleurLicht: 'var(--mentaforce-primary-light)',
  ...
  stemming: {
    ...
    kleur: 'var(--mf-blue)', kleurLicht: 'var(--mf-blue-light)',
  ...
  calorieen: {
    ...
    kleur: 'var(--mf-amber)', kleurLicht: 'var(--mf-amber-light)',
