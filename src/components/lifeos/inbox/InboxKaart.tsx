      ...
      {staat.fase === 'ok' && !staat.data.gekoppeld ? (
        <div style={{ display: 'grid', gap: 14, justifyItems: 'start' }}>
          <NogNiets
            ...
            waarom="Koppel Gmail: LifeOS zegt je 's avonds welke mails écht iets van je vragen, zodat je de inbox niet meer opent 'om even te kijken'. Alleen lezen, alleen afzender en onderwerp — nooit de inhoud, en versturen doet LifeOS nooit."
          />
